...
import time
import random
from src.equinex_sdk.client import EquiNexClient
from src.equinex_sdk.analytics import EquiNexAnalytics
...
if __name__ == "__main__":
    print(f"[{datetime.now().strftime('%H:%M:%S')}] Lyria Adapter module ready. Simulating performance.")
    from datetime import datetime
    while True:

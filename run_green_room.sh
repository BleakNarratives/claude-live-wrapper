...
echo -e "\e[1m\e[36m--- 1. INITIATING GEMINI SOUND CHECK ASSISTANT ---\e[0m"
...
# --- STEP 3: Start FFmpeg Stream to YouTube ---
echo ""
...
# --- STEP 4: Initiate Lyria Adapter (AIX Real-time Steering) ---
echo ""
echo -e "\e[1m\e[36m--- 4. LYRIA ADAPTER ACTIVE (REAL-TIME STEERING) ---\e[0m"
python3 src/lyria_adapter.py & 
LYRIA_PID=$!
echo -e "\e[36m[AIX Status]: Lyria Adapter PID: $LYRIA_PID\e[0m"
...
echo -e "\n\e[1m\e[32mLIVE! Stream is Active. Your Gemini Wingman is operating. Monitoring in VIVX window.\e[0m"
